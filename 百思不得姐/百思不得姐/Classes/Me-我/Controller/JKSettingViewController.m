...
- (void)viewDidLoad {
    ...
    self.title = @"设置";
   NSUInteger cahceSize = [SDImageCache sharedImageCache].getSize;
    //NSLog(@"%zd %@",cahceSize,NSTemporaryDirectory());
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"已使用缓存%.2fMB",size];
